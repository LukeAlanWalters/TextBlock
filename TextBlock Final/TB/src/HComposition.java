...
public class HComposition implements TextBlock {
  ...
  public boolean eqv(TextBlock tbCmp) {
    ...
    if (!(tbCmp instanceof HComposition)) {
      return false;
    } else {
      HComposition tbVCmp = (HComposition) tbCmp;
      return this.left.eqv(tbVCmp.left) && this.right.eqv(tbVCmp.right);
    } // else
  }// eqv()
